export const STRINGS = {
  hu: {
    ...
    trustLocTitle: "2 üzletünk van", trustLocDesc: "Gyimes és Szentgyörgy — nézz be hozzánk.", trustLocTag: "Gyimes & Szentgyörgy",
    trustWarrantyTitle: "Garancia mindenre", trustWarrantyDesc: "A készülékre és az alkatrészekre is.", trustWarrantyTag: "Digitális garanciajegy",
    trustTestedTitle: "Tesztelt, ellenőrzött", trustTestedDesc: "Kijelző, akku, kamera, gombok — mind.", trustTestedTag: "Minden készüléken",
  ...
  ro: {
    ...
    trustLocTitle: "Avem 2 magazine", trustLocDesc: "Ghimeș și Sfântu Gheorghe — treci pe la noi.", trustLocTag: "Ghimeș & Sfântu Gheorghe",
    trustWarrantyTitle: "Garanție la tot", trustWarrantyDesc: "Pentru dispozitiv și pentru piese.", trustWarrantyTag: "Garanție digitală",
    trustTestedTitle: "Testat, verificat", trustTestedDesc: "Ecran, baterie, cameră, butoane — tot.", trustTestedTag: "La fiecare telefon",
