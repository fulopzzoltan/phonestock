...
export const txFromApi = (r) => {
  ...
  return {
    ...
    category: r.category,
    payment: r.payment,
    paymentCashAmount: r.payment_cash_amount != null ? Number(r.payment_cash_amount) : null,
...
export const txToApi = (t, locId) => ({
  ...
  payment_cash_amount: t.payment === "Vegyes" ? Number(t.paymentCashAmount) || 0 : null,
...
export const tFromApi = (r) => ({
  ...
  warrantyKind: r.warranty_kind,
  waterDamage: !!r.water_damage,
  unlockType: r.unlock_type,
  unlockCode: r.unlock_code,
  dateIn: r.date_in,
  dateOut: r.date_out,
  readyAt: r.ready_at,
  locationId: r.location_id,
...
export const tToApi = (t, locId) => ({
  ...
  is_warranty: !!t.isWarranty,
  warranty_kind: t.isWarranty ? (t.warrantyKind || null) : null,
  water_damage: !!t.waterDamage,
  unlock_type: t.unlockType || null,
  unlock_code: t.unlockType && t.unlockType !== "Nincs" ? (t.unlockCode || null) : null,
  location_id: locId,
  imei: t.imei || null,
