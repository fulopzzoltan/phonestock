  ...
  return (
    <div style={{ background: "var(--pub-paper-raised)", border: "1.5px solid var(--primary)", borderRadius: 16, padding: 18, marginBottom: 14 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 12 }}>
        ...
        <span style={{ fontSize: 11, fontWeight: 800, letterSpacing: 0.4, color: "var(--primary-ink)", textTransform: "uppercase" }}>Akciós ajánlat</span>
      </div>
      ...
      <div style={{ fontSize: 13, color: "#5B6472", lineHeight: 1.55, marginBottom: 16 }}>
      ...
      >
        <span style={{ width: 17, height: 17, borderRadius: 8, border: "1.5px solid #C1C6CC", flexShrink: 0 }} />
