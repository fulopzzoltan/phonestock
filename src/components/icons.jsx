...
export const SearchIcon = (props) => (
  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" strokeWidth="2" {...props}>
...
export const PrintIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M6 9V3h12v6" /><rect x="4" y="9" width="16" height="8" rx="1.5" /><path d="M6 14h12v7H6z" />
  </svg>
);

/* --- Sidebar nav icons (PhoneStock Redesign) --- */

export const LogoIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M17 2H7a2 2 0 00-2 2v16a2 2 0 002 2h10a2 2 0 002-2V4a2 2 0 00-2-2zm-5 15a1.5 1.5 0 110-3 1.5 1.5 0 010 3zm3-7H9V5h6v5z" />
  </svg>
);
...
export const PhoneCaseIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const FinanceIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M12 7.5v9M14.5 10a2.5 2.5 0 00-2.5-1.6c-1.4 0-2.4.7-2.4 1.8 0 1 .8 1.5 2.4 1.9 1.7.4 2.6.9 2.6 2 0 1.2-1.1 1.9-2.6 1.9A2.7 2.7 0 019.4 14" />
  </svg>
);
...
export const InvoiceIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M14 3v4a1 1 0 001 1h4M8.5 12h7M8.5 15.5h7M8.5 8.5h3" />
  </svg>
);
...
export const WarrantyIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 3l7 2.5v5.8c0 4.2-2.9 7.6-7 8.7-4.1-1.1-7-4.5-7-8.7V5.5L12 3z" />
  </svg>
);
...
export const DropletIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 3s7 7.58 7 12a7 7 0 01-14 0c0-4.42 7-12 7-12z" />
  </svg>
);
...
export const UsersNavIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M3 19c0-3 2.7-4.8 6-4.8s6 1.8 6 4.8M16 5.5a3.2 3.2 0 010 5.6M18 19c0-2.2-.8-3.6-2-4.4" />
  </svg>
);

export const TrashNavIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M3.5 6.5h17M19 6.5l-1 13.5H6L5 6.5M9.5 6.5V4h5v2.5" />
  </svg>
);
...
export const LeaveIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M8 14l2 2 4-4" opacity=".7" />
  </svg>
);

export const RepairPriceIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M20.5 12.5L12 21l-9-9V4.5A2.5 2.5 0 015.5 2H12l8.5 8.5a2 2 0 010 2z" />
...
export const ReviewsIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M8.5 9.5l1.1 2.4 2.6.3-1.9 1.8.5 2.6-2.3-1.3-2.3 1.3.5-2.6-1.9-1.8 2.6-.3z" fill="currentColor" stroke="none" opacity=".7" />
  </svg>
);
...
export const GridViewIcon = (props) => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" {...props}>
...
export const ConsignmentIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const SamsungIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const CartIcon = (props) => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M2.5 3h2.2l2.6 12.6a2 2 0 002 1.6h8.7a2 2 0 002-1.6L21.5 7H6" />
  </svg>
);
...
export const WhatsappIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21h.004c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.87 9.87 0 0012.04 2zm0 1.67c2.19 0 4.25.85 5.79 2.4a8.18 8.18 0 012.41 5.84c0 4.55-3.7 8.25-8.25 8.25a8.23 8.23 0 01-4.19-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.19 8.19 0 01-1.26-4.39c0-4.55 3.7-8.24 8.29-8.24zm-4.55 4.5c-.16 0-.42.06-.64.31-.22.25-.85.83-.85 2.02s.87 2.35.99 2.51c.12.16 1.68 2.68 4.14 3.65 2.04.81 2.46.65 2.9.61.44-.04 1.42-.58 1.62-1.14.2-.56.2-1.04.14-1.14-.06-.1-.22-.16-.46-.28-.24-.12-1.42-.7-1.64-.78-.22-.08-.38-.12-.54.12-.16.24-.62.78-.76.94-.14.16-.28.18-.52.06-.24-.12-1.01-.37-1.93-1.19-.71-.63-1.19-1.42-1.33-1.66-.14-.24-.02-.37.1-.49.11-.11.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.54-1.31-.75-1.79-.2-.47-.4-.4-.55-.41z" />
  </svg>
);
