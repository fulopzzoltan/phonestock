...
export default function PublicHeader({ children, activeNav = "stock", lang = "hu", langSwitchHref, minimal = false }) {
  ...
  return (
    <>
    <div className="pub-topbar" style={{ transform: hideAnnounce ? `translateY(-${announceRef.current?.offsetHeight || 0}px)` : "translateY(0)" }}>
      <div className="pub-announce-bar" ref={announceRef}>
